...
import org.salah.compresers.*;
import org.salah.filters.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> filterClass = Class.forName("org.salah.filters."+filterClassName);
            ImageFilter filter = (ImageFilter) filterClass.getDeclaredConstructor().newInstance();
            framework.setFilter(filter);

            Class<?> compressorClass = Class.forName("org.salah.compresers."+compressorClassName);
